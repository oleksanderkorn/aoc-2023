...
public class Day15 {
  public static void main(String[] args) {
    ...
    String test = InputReader.readInputString("resources/day15test.txt");
    String real = InputReader.readInputString("resources/day15.txt");
    System.out.println("____________");
    System.out.println("part one test: " + day15.partOne(test));
    System.out.println("part one real: " + day15.partOne(real));
    System.out.println("____________");
    System.out.println("part two test: " + day15.partTwo(test));
    System.out.println("part two real: " + day15.partTwo(real));
    System.out.println("____________");
  }
  ...
  private int partTwo(String input) {
    ...
    for (String string : split) {
      if (string.contains("=")) {
        ...
        Map<String, Integer> labels = boxes.getOrDefault(hash, new LinkedHashMap<>());
        labels.put(label, value);
        boxes.put(hash, labels);
    ...
    for (Map.Entry<Integer, Map<String, Integer>> box : boxes.entrySet()) {
      int index = 1;
      for (Integer labelLength : box.getValue().values()) {
        int focalLength = (box.getKey() + 1) * labelLength * index;
        result += focalLength;
        index++;
      }
    }
